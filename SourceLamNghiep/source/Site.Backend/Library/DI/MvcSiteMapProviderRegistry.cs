...
namespace Site.Backend.Library.DI
{
        ...
        : Registry
    {
        public MvcSiteMapProviderRegistry()
        {
            ...
            string[] includeAssembliesForScan = new string[] { "Site.Backend" };
...
// typeof(SiteMapNodeVisibilityProviderStrategy)
            ...
            string resourceBaseName = "Share.Messages.BreadCrumb.Backend.BeBreadCrumb";

            // A reference to the assembly where your resources reside.
            Assembly resourceAssembly = typeof(Share.Messages.BackendMessage).Assembly;
            ...
            // Setup cache
            SmartInstance<CacheDetails, ICacheDetails> cacheDetails;
