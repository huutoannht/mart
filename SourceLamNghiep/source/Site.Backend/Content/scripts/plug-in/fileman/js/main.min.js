...
function fileUploaded(res) {
    if (res.res == 'ok' && res.msg) {
        ...
        window.opener.CKEDITOR.tools.callFunction(RoxyUtils.GetUrlParam('CKEditorFuncNum'), "/Content/Data/Images/" + res.fileName);
        $('#dlgAddFile').dialog('close');
        self.close();
        //var d = Directory.Parse($('#hdDir').val());
        //d.ListFiles(true);
