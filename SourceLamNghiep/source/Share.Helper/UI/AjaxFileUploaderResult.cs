...
namespace Share.Helper.UI
{
    ...
    /// </remarks>
    public class AjaxFileUploaderResult : ActionResult
    {
        ...
        public AjaxFileUploaderResult(bool success, object otherData = null, string error = null, bool? preventRetry = null)
        {
            _success = success;
            _error = error;
